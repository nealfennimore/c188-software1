...
public class MainScreenController implements Initializable {
    ...
    @FXML private void loadAddPart() throws IOException {
        SceneController.load(FXMLLoader.load(getClass().getResource( "AddPart.fxml" )));
    }

    @FXML private void loadEditPart() throws IOException {
        SceneController.load(FXMLLoader.load(getClass().getResource( "EditPart.fxml" )));
    }
    
    @FXML private void loadAddProduct() throws IOException {
        SceneController.load(FXMLLoader.load(getClass().getResource( "AddProduct.fxml" )));
    }

    @FXML private void loadEditProduct() throws IOException {
        SceneController.load(FXMLLoader.load(getClass().getResource( "EditProduct.fxml" )));
    }
